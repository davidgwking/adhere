...
function objectValidator(namespace, schema, definitions, engine) {
  ...
  function properties(obj) {
    ...
    Object.keys(obj).forEach(function (property) {
      ...
      var result = engine.validate(obj[property], matchedSchema, definitions, [namespace, property].join('.'), obj);
  ...
  function dependencies(obj) {
    ...
    Object.keys(propsWithDeps).forEach(function (propWithDep) {
      ...
      // handle schema dep
      var schemaDep = deps;
      var result = engine.validate(obj, schemaDep, definitions, namespace);
      if (!result.valid) {
        valid = false;
