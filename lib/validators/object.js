...
function objectValidator(namespace, schema, engine) {
  ...
  function properties(obj) {
    ...
    Object.keys(obj).forEach(function (property) {
      ...
      var result = engine.validate(obj[property], matchedSchema, [namespace, property].join('.'), obj);
  ...
  function dependencies(obj) {
    ...
    Object.keys(propsWithDeps).forEach(function (propWithDep) {
      ...
      // handle schema dep
      var schemaDep = deps;
      var result = engine.validate(obj, schemaDep, namespace);
      if (!result.valid) {
        valid = false;
...
module.exports = function getObjectValidator(namespace, schema, engine) {
  return objectValidator(namespace, schema, engine);
};
