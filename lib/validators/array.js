  ...
  function items(arr) {
    ...
    if (Array.isArray(schemas)) {
      ...
      arr.forEach(function (val, index) {
        ...
        else result = engine.validate(val, schemas[index], [namespace, index].join('.'), arr);
    ...
    arr.forEach(function (val, index) {
      ...
      var result = engine.validate(val, schm, [namespace, index].join('.'), arr);
...
module.exports = function getArrayValidator(namespace, schema, engine) {
  return arrayValidator(namespace, schema, engine);
};
